...
def main() -> None:
    ...
    args.markdown_output.write_text(render_progression_markdown(payload))
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=REPO_ROOT / "artifacts/visual_analysis/render-progression.json",
    )
    parser.add_argument(
        "--markdown-output",
        type=Path,
        default=REPO_ROOT / "artifacts/visual_analysis/render-progression.md",
    )
